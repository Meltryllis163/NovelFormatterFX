...
public class ChapterMaxLengthController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tile.descriptionProperty()
                .bind(I18nUtil.createStringBinding("App.ChapterInput.MaxLengthTile.Desc"));
        ...
        tile.titleProperty().bind(I18nUtil.createStringBinding("App.ChapterInput.MaxLengthTile.Title"));

        // ComboBox
        UniqueListProperty<Integer> itemUniqueListProperty = InputFormatProperty.CHAPTER_MAX_LENGTH_UNIQUE_LIST;
        comboBox.itemsProperty().bind(itemUniqueListProperty);
        ...
        if (selectedMaxLength > 0) {
            itemUniqueListProperty.add(selectedMaxLength);
