...
public class MTextField extends TextField {
    ...
    public MTextField(String text) {
        ...
        editableProperty().addListener((observable, oldValue, newValue) -> setContextMenu(createContextMenu()));
    }
    ...
    private ContextMenu createContextMenu() {
        ...
        // 全选
        ContextMenuItem selectAll = new ContextMenuItem(null, FontIcon.of(Feather.MAXIMIZE), this,
        ...
        if (!isEditable()) {
            contextMenu.getItems().addAll(copy, new SeparatorMenuItem(), selectAll);
            return contextMenu;
        }
