...
public abstract class AbstractParser {
     ...
     * 解析文本。
     *
     * @param trimmingText 需要解析的文本字符串，该文本应该已经经过 {@link StrUtil#trim(CharSequence)} 清理空白字符串。
     */
     ...
     *
     * @param trimmingText 需要解析的文本，该文本应该已经经过 {@link StrUtil#trim(CharSequence)} 清理空白字符串。
